...
declare type DistributiveOmit<T, K extends string | number | symbol> = T extends any ? K extends keyof T ? Omit<T, K> : T : T;
declare type PropsWithoutRef<T> = DistributiveOmit<T, 'ref'>;
/**
 ...
 * ```
 */
export declare type WebComponentProps<I extends HTMLElement> = React.DetailedHTMLProps<React.HTMLAttributes<I>, I> & ElementProps<I>;
/**
 * Type of the React component wrapping the web component. This is the return
 * type of `createComponent`.
 */
export declare type ReactWebComponent<I extends HTMLElement, E extends EventNames = {}> = React.ForwardRefExoticComponent<PropsWithoutRef<ComponentProps<I, E>> & React.RefAttributes<I>>;
declare type ElementProps<I> = Partial<Omit<I, keyof HTMLElement>>;
declare type ComponentProps<I, E extends EventNames = {}> = Omit<React.HTMLAttributes<I>, keyof E> & EventListeners<E> & ElementProps<I>;
/**
